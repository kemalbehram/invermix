                        ...
                        <div class="tab-content" id="pills-tabContent">
                          <div class="p-5 tab-pane fade show active" id="pills-home" role="tabpanel" >
                            <div class="form-group">
                              ...
                              <!-- <div class="row margin_top50">
                                  <div class="col-md-12" >
                                      <h3><i class="fa fa-coggs"></i> {{ __('Configuración Moneda') }} </h3>
                                  </div>
                                  <div   class="col-md-6 ">
                          ...
                          <div class="tab-pane fade p-5" id="referral" role="tabpanel" aria-labelledby="referral-tab">
                            ...
                            <div id="Multi_level_settings" class="@if(env('REF_SYSTEM') != 'Multi_level'){{__('cont_display_none')}}@endif">
                              <div class="row mt-5">
                                  <div class="col-sm-6">
                                    <h6> {{ __('Referal Levels') }} </h6>
                                    <input type="number" name="referal_levels" value="{{env('REF_LEVEL_CNT')}}" class="form-control" placeholder="4" onkeyup="set_inputs(this.value)" >
                                  </div>
                              </div>
                                ...
                                @foreach($ref_set as $ref_item)
                                  <div class="col-sm-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="{{$ref_item->name}}" value="{{$ref_item->val*100}}" class="form-control" >
                                      </div>
                                  </div>
                                @endforeach
                              </div>
