...
<h1> Política de privacidad de Invermix Capital </h1>

<p> En invermixcapital.com, accesible desde invermixcapital.com, una de nuestras principales prioridades es la privacidad de nuestros visitantes. Este documento de Política de privacidad contiene tipos de información recopilada y registrada por invermixcapital.com y cómo la usamos. </p>
...
<p> Esta Política de privacidad se aplica solo a nuestras actividades en línea y es válida para los visitantes de nuestro sitio web con respecto a la información que compartieron y / o recopilaron en invermixcapital.com. Esta política no se aplica a ninguna información recopilada fuera de línea o mediante canales que no sean este sitio web. </p>
...
<li> Comprenda y analice cómo utiliza nuestro webste </li>
...
<P> Puede consultar esta lista para encontrar la Política de privacidad de cada uno de los socios publicitarios de invermixcapital.com. </p>

<p> Los servidores de anuncios de terceros o las redes de anuncios utilizan tecnologías como cookies, JavaScript o Web Beacons que se utilizan en sus respectivos anuncios y enlaces que aparecen en invermixcapital.com, que se envían directamente al navegador de los usuarios. Reciben automáticamente su dirección IP cuando esto ocurre. Estas tecnologías se utilizan para medir la eficacia de sus campañas publicitarias y / o para personalizar el contenido publicitario que ve en los sitios web que visita. </p>

<p> Tenga en cuenta que invermixcapital.com no tiene acceso ni control sobre estas cookies que utilizan los anunciantes de terceros. </p>

<h2> Políticas de privacidad de terceros </h2>

<p> La Política de privacidad de invermixcapital.com no se aplica a otros anunciantes o sitios web. Por lo tanto, le recomendamos que consulte las respectivas Políticas de privacidad de estos servidores de anuncios de terceros para obtener información más detallada. Puede incluir sus prácticas e instrucciones sobre cómo excluirse de determinadas opciones. </p>
...
<p> Solicite que una empresa que recopila los datos personales de un consumidor divulgue las categorías y piezas específicas de datos personales que una empresa ha recopilado sobre los consumidores. </p>
<p> Solicite que una empresa elimine cualquier dato personal sobre el consumidor que haya recopilado una empresa. </p>
...
<p> Si realiza una solicitud, tenemos un mes para responderle. Si quisieras


<h2> Derechos de protección de datos de GDPR </h2>
...
<p> El derecho a la eliminación: tiene derecho a solicitar que eliminemos sus datos personales, bajo ciertas condiciones. </p>
...
<p> El derecho a oponerse al procesamiento: tiene derecho a oponerse a nuestro procesamiento de sus datos personales, bajo ciertas condiciones. </p>
...
<p> Si realiza una solicitud, tenemos un mes para responderle. Si desea ejercer alguno de estos derechos, comuníquese con nosotros. </p>
...
<p> invermixcapital.com no recopila a sabiendas ninguna Información de identificación personal de niños menores de 13 años. Si cree que su hijo proporcionó este tipo de información en nuestro sitio web, le recomendamos que se comunique con nosotros de inmediato y haremos lo nuestro. mejores esfuerzos para eliminar de inmediato dicha información de nuestros registros. </p>
				...
				<div class="row">
                    ...
                    <div class="col-lg-7">
                        ...
                        <li>
							...
							<li>
								<a target="a_blank" href="https://twitter.com/invermix_capital" data-toggle="tooltip" data-placement="top" title="Twitter">
