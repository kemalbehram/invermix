							...
							<div class="card margin_btm_0">
								<div class="card-header">
									<div class="card-head-row">
										<div class="card-title headtext_blue"><i class="fa fa-bell fa-1x"></i>{{ __('Notificaciones') }}</div>
									</div>
								</div>
							...
							<div class="card margin_btm_0 message-notif-scroll scrollbar-outer read_panel_h">
								<div id="read_not" class="pt-3 p-3">
									@if(isset($msgID))
                                        ...
                                        <p>{!! $m->message !!}</p>
                                    @else
                                    	<div class="alert alert-info">{{__('Seleccionar una notificación')}}</div>
									@endif
