...
Route::post('/user/update/pwd', 'userController@reset_pwd')->middleware('auth');
...
Route::post('/admincreate', 'userController@admin_system')->name('admin_system');
