                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title"><?php echo e(__('Historial de Retiro')); ?></div>
                                    </div>
                                </div>
                                <div class="card-body">
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\invermix\invermix\resources\views/user/withdrawal.blade.php ENDPATH**/ ?>