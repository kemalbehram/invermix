<div id="ActivateINJ" class="container edit_pack_cont" >
  <div class="row wd_row_pad">
    <div class="col-md-4">&emps;</div>
    <div class="col-md-4" align="Center">
      <div class="card mt50">
        <div class="card-header card_header_bg_blue">
          <h2 class="text-white">Activar Inyección</h2>
        </div>
        <div id="" class="edit_pack_pad_n30_5 card-body">
          <form action="/admin/activate/user_inj" method="post">
              ...
              <div class="input-group">
                ...
                <select class="form-control" id="company" name="company">
                       <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($company->id); ?>"><?php echo e($company->name_comp); ?></option>
              ...
              <div class="form-group">
                <br>
                  ...
                  <span style="">
                    <a id="ActivateINJ_close" href="javascript:void(0)" class="btn btn-danger">Cancelar</a>
                  </span>
                  <br>
              </div>
          </form>
      ...
      <script type="text/javascript">
        $('#ActivateINJ_close').click( function(){
          $('#ActivateINJ').hide();
        });
      </script>
      <!-- end close btn -->
  ...
  <script type="text/javascript">
  function activate_inj(id, usn, package, capital, status, currency, token)
{
	$('#id').val(id);
	$('#usn').val(usn);
    $('#package').val(package);
...
<?php /**PATH C:\xampp\htdocs\invermix\invermix\resources\views/admin/temp/activate_inj.blade.php ENDPATH**/ ?>