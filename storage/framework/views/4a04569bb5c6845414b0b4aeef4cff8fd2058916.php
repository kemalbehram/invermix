            ...
            <form action="/admin/addNew/admin" method="post">
              ...
              <div class="input-group">  
                <div class="input-group-prepend">              
                  ...
                  <input id="" type="email" class="form-control" name="email" placeholder="Enter staff email address" required>
              </div>
              <br>
              <div class="input-group"> 
                <div class="input-group-prepend">               
              ...
              <div class="form-group">
                <br>
                  <button class="collb btn btn-info"><?php echo e(__('Add Admin')); ?></button>
                  <br>
              </div>              
            </form>
        </div>
    </div>
</div><?php /**PATH /home/superloc/dynamis.me/test.dynamis.me/core/resources/views/admin/temp/add_new_admin.blade.php ENDPATH**/ ?>