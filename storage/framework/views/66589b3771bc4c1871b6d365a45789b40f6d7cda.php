            ...
            <div class="row">
                <div class="col-sm-12" align="">
                   <form action="/admin/send/notification" method="post">
                        ...
                        <div class="form-group">                          
                          <label><?php echo e(__('Users (Enter usersname(s) separated by "," or leave empty to send notification to all)')); ?></label>
                       ...
                       <div class="form-group" align="center">
                          <br>
                           <button disabled class="btn btn-info fa fa-paper-plane"> <?php echo e(__('Send Message (Disabled on Demo)')); ?></button>
                       </div>
                   </form>
                </div>
...
<script type="text/javascript">
  $('#msg_state').val(0);
</script><?php /**PATH /home/superloc/dynamis.me/maxprofit.dynamis.me/core/resources/views/admin/temp/send_not.blade.php ENDPATH**/ ?>