        ...
        <div class="datatable-dashv1-list custom-datatable-overright dashtwo-project-list-data">
            <form action="/admin/addNew/admin" method="post">
              ...
              <div class="form-group">
                <br>
                  <button class="collb btn btn-info" disabled><?php echo e(__('Add (Disabled on Demo)')); ?></button>
                  <br>
              </div>              
            </form>
        </div>
    </div>
</div><?php /**PATH C:\wamp64\www\dh\core\resources\views/admin/temp/add_new_admin.blade.php ENDPATH**/ ?>