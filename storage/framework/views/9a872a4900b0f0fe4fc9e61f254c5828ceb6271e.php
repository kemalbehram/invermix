                    ...
                    <div class="col-sm-12 card">
                      <form id="settings_form" action="/admin/update/site/settings" method="post">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                          <div class="p-5 tab-pane " id="pills-home" role="tabpanel" >
                            <div class="form-group">
                              ...
                              <!-- <div class="row margin_top50">
                                  <div class="col-md-12" >
                                      <h3><i class="fa fa-coggs"></i> <?php echo e(__('Configuración Moneda')); ?> </h3>
                                  </div>
                                  <div   class="col-md-6 ">
                                      <div class="card pad_20" >
                                          <h5> <?php echo e(__('Mondeda símbolo/Código')); ?> </h5>
                          ...
                          <div class="p-5 tab-pane fade show active "  id="currency_config" role="tabpanel" >
                            <div class="row">
                                 ...
                                 <div   class="col-md-6 ">
                                      <div class="card pad_20" >
                                          <h5> <?php echo e(__('Mondeda símbolo/Código')); ?> </h5>
                                          <input type="text" name="cur_rd" value="<?php echo e($curr->currency_rd); ?>" class="form-control" placeholder="currency symbol or code" required >
                                      </div>
                                  </div>

                                  <div   class="col-md-6">
                                      <div class="card form-group pad_20" >
                                          <h5> <?php echo e(__('Valor de moneda en dolar EE.UU.')); ?> </h5>
                                          <input type="text" name="cur_conv_rd" value="<?php echo e($curr->currency_conversion_rd); ?>" class="form-control" placeholder="Currency conversion rate to dollar" required >
                                      </div>
                                  </div>
                            </div>
                            ...
                            <div class="row">
                                 <div   class="col-md-6 ">
                                      <div class="card pad_20" >
                                          <h5> <?php echo e(__('Mondeda símbolo/Código')); ?> </h5>
                                          <input type="text" name="cur_us" value="<?php echo e($curr->currency_us); ?>" class="form-control" placeholder="currency symbol or code" required >
                                      </div>
                                  </div>
                                  <div   class="col-md-6">
                                      <div class="card form-group pad_20" >
                                          <h5> <?php echo e(__('Valor de moneda en dolar EE.UU.')); ?> </h5>
                                          <input type="text" name="cur_conv_us" value="<?php echo e($curr->currency_conversion_us); ?>" class="form-control" placeholder="Currency conversion rate to dollar" required >
                                      </div>
                                  </div>
                            </div>
                          </div>
                          ...
                          <div class="tab-pane fade p-5" id="referral" role="tabpanel" aria-labelledby="referral-tab">
                            ...
                            <div id="Multi_level_settings" class="<?php if(env('REF_SYSTEM') != 'Multi_level'): ?><?php echo e(__('cont_display_none')); ?><?php endif; ?>">
                              <div class="row mt-5">
                                  <div class="col-sm-6">
                                    <h6> <?php echo e(__('Referal Levels')); ?> </h6>
                                    <input type="number" name="referal_levels" value="<?php echo e(env('REF_LEVEL_CNT')); ?>" class="form-control" placeholder="4" onkeyup="set_inputs(this.value)" >
                                  </div>
                              </div>

                              <div id="warning_div" class="row mt-5">
                                <div class="col-sm-12 alert alert-warning text-center">Note: Entering '4' means 4/100 as referal percentages</div>
                              </div>
                                ...
                                <?php $__currentLoopData = $ref_set; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <div class="col-sm-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="<?php echo e($ref_item->name); ?>" value="<?php echo e($ref_item->val*100); ?>" class="form-control" >
                                      </div>
                                  </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </div>
                        ...
                        <div class="row margin_top50 mb-5">
                          <div   class="col-md-12">
                            <button class="btn btn-info float-right"  onclick="load_post_ajax('/admin/update/site/settings', 'settings_form', 'admin_settings_form' )" > <?php echo e(__('Guardar Cambios')); ?> </button>
                          </div>
                        </div>
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\invermix\invermix\resources\views/admin/settings.blade.php ENDPATH**/ ?>