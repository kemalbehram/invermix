          ...
          <form id="wd_formssss" action="/user/wdraw/earning" method="post">
              ...
              <div class="form-group">
                <br><br>
                  ...
                  <span style="">
                    <a id="div_withdrawal_close" href="javascript:void(0)" class="btn btn-danger"> <?php echo e(__('Cancelar')); ?> </a>
                  </span>
                  <br>
              </div>
          </form>
...
<?php /**PATH /Applications/MAMP/htdocs/invermix/resources/views/user/inc/withdrawal.blade.php ENDPATH**/ ?>