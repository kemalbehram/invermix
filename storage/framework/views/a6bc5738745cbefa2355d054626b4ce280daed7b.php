        ...
        <div class="datatable-dashv1-list custom-datatable-overright dashtwo-project-list-data">
            <form action="/admin/addNew/admin" method="post">
              ...
              <div class="form-group">
                <br>
                  <button disabled class="collb btn btn-info"><?php echo e(__('Add Admin (Disabled on Demo)')); ?></button>
                  <br>
              </div>              
            </form>
        </div>
    </div>
</div><?php /**PATH /home/superloc/dynamis.me/maxprofit.dynamis.me/core/resources/views/admin/temp/add_new_admin.blade.php ENDPATH**/ ?>