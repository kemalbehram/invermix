						...
						<div class="accordion" id="tour-faq">
							...
							<div class="single-accordion">
							  ...
							  <div id="collapseFour" class="collapse" data-parent="#tour-faq">
								<div class="accordion-body">
									Contamos con diferentes tipo de planes de inversión, de lo cual dependerá el tiempo que puedes retirar la ganancia generada por una inversión, este tiempo va desde tres meses a un año luego de la inversión inicial.
								</div>
							  </div>
							</div>
						  </div>
