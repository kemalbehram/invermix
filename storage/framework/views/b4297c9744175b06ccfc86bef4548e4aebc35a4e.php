<div id="succ" class="container popmsgContainer">
  ...
  <div id="readmsg" class="container popmsgContainer" >
    <div class="row wd_row_pad">
      ...
      <div class="col-md-4 popmsg-mobile pop_read_msg"  align="Center">
            <span class="">            
                <a id="readmsg_close" href="javascript:void(0)" class="btn btn-danger"><?php echo e(__('X')); ?></a>        
            </span>   
          <div class="sparkline8-list shadow-reset mg-tb-30" >
              <div class="sparkline8-hd" >
                  <div class="main-sparkline8-hd">
                      <h1><?php echo e(__('Read Messages')); ?></h1>
                  </div>
              </div>
              <div class="">
                  <div class="" >
  ...
  </div><?php /**PATH /home/superloc/dynamis.me/maxprofit.dynamis.me/core/resources/views/user/inc/alert.blade.php ENDPATH**/ ?>