            ...
            <table class="display table table-stripped table-hover">
                <thead>
                    <tr>
                       ...
                       <th> <?php echo e(__('Min. RD$')); ?> </th>
                       <th> <?php echo e(__('Max. RD$')); ?> </th>
                       <th> <?php echo e(__('Min. US$')); ?> </th>
                       <th> <?php echo e(__('Max. US$')); ?> </th>
                       <th> <?php echo e(__('Interés (%)')); ?> </th>
                       <th> <?php echo e(__('Duración')); ?> </th>
                       <th> <?php echo e(__('Intervalo de Retiro')); ?> </th>
                       <th> <?php echo e(__('On/Off')); ?> </th>
                       <th> <?php echo e(__('Manejar')); ?> </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php if(count($packs) > 0 ): ?>
                        <?php $__currentLoopData = $packs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(number_format($dep->min)); ?></td>
                                <td><?php echo e(number_format($dep->max)); ?></td>
                                <td><?php echo e(number_format($dep->mindol)); ?></td>
                                <td><?php echo e(number_format($dep->maxdol)); ?></td>
                                ...
                                <td>
                                    <?php if($adm->role == 3 || $adm->role == 2): ?>
                                        <a id="<?php echo e($dep->id); ?>" title="Edit Package" href="javascript:void(0)" onclick="edit_pack(this.id, '<?php echo e($dep->min); ?>', '<?php echo e($dep->max); ?>', '<?php echo e($dep->mindol); ?>', '<?php echo e($dep->maxdol); ?>', '<?php echo e($dep->daily_interest*$dep->period*100); ?>', '<?php echo e($dep->withdrwal_fee); ?>', '<?php echo e(csrf_token()); ?>', '<?php echo e($dep->currency); ?>')">
...
<?php /**PATH /Applications/MAMP/htdocs/invermix/resources/views/admin/temp/inv_pack.blade.php ENDPATH**/ ?>