...
<div class="alert alert-info inv_alert_cont" >
    <div class="row inv_alert_top_row">
        <div class="col-xs-12 pad_top_5" align="center" >
            <h4 class="u_case"><?php echo e(__('Plan')); ?>: <?php echo e($in->package); ?></h4>
...
<?php /**PATH /Applications/MAMP/htdocs/invermix/resources/views/user/inc/mob_inv.blade.php ENDPATH**/ ?>