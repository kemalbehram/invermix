...
<body>
	<div class="wrapper">
				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						<li class="nav-item dropdown hidden-caret">
							<a class="nav-link dropdown-toggle" href="<?php echo e(route('support.index')); ?>" role="button">
								<?php                                  
		...
		<div class="sidebar sidebar-style-2">			
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					<div class="user-plus" style="background-color: #1572E8;">
		...
		<!-- End Sidebar --><?php /**PATH /home/superloc/dynamis.me/maxprofit.dynamis.me/core/resources/views/admin/atlantis/header.blade.php ENDPATH**/ ?>