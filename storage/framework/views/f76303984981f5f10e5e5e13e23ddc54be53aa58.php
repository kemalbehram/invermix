                                    ...
                                    <form action="/admin/change/pwd" method="post">
                                        ...
                                        <div class="input-group"> 
                                          ...
                                          <div class="form-group">
                                            <br>
                                              <button class="collb btn btn-info"> <?php echo e(__('Update Password')); ?> </button>
                                              <br>
                                          </div>
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/superloc/dynamis.me/test.dynamis.me/core/resources/views/admin/change_pwd.blade.php ENDPATH**/ ?>