...
class TestRunner extends BaseTestRunner
{
    ...
    public function doRun(Test $suite, array $arguments = [], bool $exit = true): TestResult
    {
        ...
        if ($codeCoverageReports > 0) {
            ...
            if (isset($arguments['ignoreDeprecatedCodeUnitsFrodynamisCoverage'])) {
                $codeCoverage->setIgnoreDeprecatedCode(
                    $arguments['ignoreDeprecatedCodeUnitsFrodynamisCoverage']
                );
            }
    ...
    protected function handleConfiguration(array &$arguments): void
    {
        ...
        if (isset($arguments['configuration'])) {
            ...
            if (isset($phpunitConfiguration['ignoreDeprecatedCodeUnitsFrodynamisCoverage']) && !isset($arguments['ignoreDeprecatedCodeUnitsFrodynamisCoverage'])) {
                $arguments['ignoreDeprecatedCodeUnitsFrodynamisCoverage'] = $phpunitConfiguration['ignoreDeprecatedCodeUnitsFrodynamisCoverage'];
            }
