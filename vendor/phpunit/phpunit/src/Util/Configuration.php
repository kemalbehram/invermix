 ...
 *          ignoreDeprecatedCodeUnitsFrodynamisCoverage="false"
...
final class Configuration
{
    ...
    public function getPHPUnitConfiguration(): array
    {
        ...
        if ($root->hasAttribute('ignoreDeprecatedCodeUnitsFrodynamisCoverage')) {
            $result['ignoreDeprecatedCodeUnitsFrodynamisCoverage'] = $this->getBoolean(
                (string) $root->getAttribute('ignoreDeprecatedCodeUnitsFrodynamisCoverage'),
                false
            );
        }
